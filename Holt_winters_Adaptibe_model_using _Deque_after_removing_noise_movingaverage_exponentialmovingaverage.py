...
# Sorting the historical and forecast dates and values
    ...
    plt.legend()
    plt.grid(True)
    # plt.savefig(f"Holt_winters_Adaptibe_model_using _Deque_after_removing_noise_movingaverage_exponentialmovingaverage/29NOV2023/using_Moving_Average/Holt-Winters Forecasting for {target_instr_code}.png")
